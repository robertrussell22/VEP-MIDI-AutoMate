...
wrapper = tk.Frame(root, padx=12, pady=12)
...
instructions_text = (
    ...
    'What you need to do:\n'
    f' {BULLET} Open VEP with your target instance active.\n'
    ...
    f' {BULLET} find VEP window, maximise it, bring it to front, check for an active instance, reset layout, maximise \'MIDI Controllers\' section \n'
    ...
    f' {BULLET} Sudden popups on your computer can cause confusion. Open VEP on a screen that is unlikely to see these.\n'
